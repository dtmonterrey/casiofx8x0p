...
CasioBasicHelper::CasioBasicHelper()
{

}

QString CasioBasicHelper::getConnectionString(BaudRate &baudRate)
{
    return QString("LOAD \"COM0:%1,E,8,2,N,N,N,B,N\"").arg(baudRate.getIndex());
}
